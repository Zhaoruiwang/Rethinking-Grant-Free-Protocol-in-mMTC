...
cov_time_200 = zeros(length(time_set), 1);
...
for l = 1:length(time_set)
    ...
    for j = 1:ite
        ...
        cov_time_200(l) = cov_time_200(l) + cov_time1;
        Thd_cd=0:0.0005:1;
...
for i=1:n
    ...
    value_200(i)=(FAE_sel(i,index_sel)+MDE_sel(i,index_sel))/2;
end

figure;
p3 = semilogy(cov_time_200,value_200,'o-', LineWidth=2);hold on;
legend(p3, {'$K=200, L_I=4, L_{II}=173,D=2, \alpha=0.01$'}, 'Interpreter', 'latex');
xlabel('CPU time');
